...
async function calculateShippingCost() {
    ...
    try {
        ...
        const response = await fetch(`${RAJAONGKIR_BASE_URL}/api/rajaongkir/calculate`, options);
        ...
        if (data && data.data && data.data.meta && data.data.meta.code === 200) {
            shippingCosts.value = data.data.data || [];
